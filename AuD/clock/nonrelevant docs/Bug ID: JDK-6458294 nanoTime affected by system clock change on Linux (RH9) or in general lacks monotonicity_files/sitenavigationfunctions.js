...
function BrowserDetectionObject(){
	...
	this.is_ns = ((this.agt.indexOf("mozilla")!=-1) && (this.agt.indexOf("spoofer")==-1) && (this.agt.indexOf("compatible") == -1) && (this.agt.indexOf("opera")==-1) && (this.agt.indexOf("webtv")==-1) && (this.agt.indexOf("firefox")==-1));
...
function ShowCurrentBrowserInfo(){
   ...
   appVersion = " + g_objBrowserDetection.appVersion + "<br>\
   majorVersion = " + g_objBrowserDetection.majorVersion + "<br>\
   minorVersion = " + g_objBrowserDetection.minorVersion + "<br>\
   is_ie = " + g_objBrowserDetection.is_ie + "<br>\
   is_ns = " + g_objBrowserDetection.is_ns + "<br>\
   is_ff = " + g_objBrowserDetection.is_ff + "<br>\
   is_ns3 = " + g_objBrowserDetection.is_ns3 + "<br>\
   is_ns4 = " + g_objBrowserDetection.is_ns4 + "<br>\
   is_ns6 = " + g_objBrowserDetection.is_ns6 + "<br>\
   is_ns7 = " + g_objBrowserDetection.is_ns7 + "<br>\
   is_ns4up = " + g_objBrowserDetection.is_ns4up + "<br>\
   is_ns6up = " + g_objBrowserDetection.is_ns6up + "<br>\
   is_ns7up = " + g_objBrowserDetection.is_ns7up + "<br>\
   is_ie3 = " + g_objBrowserDetection.is_ie3 + "<br>\
   is_ie4 = " + g_objBrowserDetection.is_ie4 + "<br>\
   is_ie5 = " + g_objBrowserDetection.is_ie5 + "<br>\
   is_ie6 = " + g_objBrowserDetection.is_ie6 + "<br>\
   is_ie4up = " + g_objBrowserDetection.is_ie4up + "<br>\
   is_ie5up = " + g_objBrowserDetection.is_ie5up + "<br>\
   is_ie6up = " + g_objBrowserDetection.is_ie6up + "<br>\
   is_ff1 = " + g_objBrowserDetection.is_ff1 + "<br>\
   is_ff1up = " + g_objBrowserDetection.is_ff1up + "<br>");
}
